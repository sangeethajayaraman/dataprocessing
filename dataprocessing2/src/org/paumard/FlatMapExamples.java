package dataprocessing2.src.org.paumard;
...
public class FlatMapExamples {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Stream<String> stream1 = Files.lines(Paths.get("dataprocessing2/files/TomSawyer_01.txt"));
        Stream<String> stream2 = Files.lines(Paths.get("dataprocessing2/files/TomSawyer_02.txt"));
        Stream<String> stream3 = Files.lines(Paths.get("dataprocessing2/files/TomSawyer_03.txt"));
        Stream<String> stream4 = Files.lines(Paths.get("dataprocessing2/files/TomSawyer_04.txt"));
      ...
      // System.out.println("# streams: " + streamOfStreams.count());
       ...
       // System.out.println("# lines " + streamOfLines.count());
        ...
        Stream<String> streamOfWords =
             Stream.of(stream1, stream2, stream3, stream4) // stream of streams of lines
            .flatMap(Function.identity())   //stream of lines
            .flatMap(lineSplitter)     // stream of words
                .map(word -> word.toLowerCase())
                .filter(word -> word.length() == 4)
                .distinct();
        //System.out.println("# words :" + streamOfWords);
